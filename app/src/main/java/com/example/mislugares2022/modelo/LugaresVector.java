...
public class LugaresVector implements RepositorioLugares, Iterator {
    ...
    public static ArrayList<Lugar> ejemploLugares() {
        ...
        lugares.add(new Lugar(siguienteId(), "Escuela Politécnica Superior de Gandía",
        ...
        lugares.add(new Lugar(siguienteId(), "Al de siempre",
        ...
        lugares.add(new Lugar(siguienteId(), "androidcurso.com",
                "ciberespacio", 0.0, 0.0, TipoLugar.EDUCACION,
                962849300, "http://androidcurso.com",
                "Amplia tus conocimientos sobre Android.", 5));

        lugares.add(new Lugar(siguienteId(), "Barranco del Infierno",
        ...
        lugares.add(new Lugar(siguienteId(), "La Vital", "Avda. de la Vital, 0 46701 Gandía (Valencia)",
